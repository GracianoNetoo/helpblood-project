...
const saveProfile = async () => {
  ...
  profileSuccess.value = nextEmail !== currentEmail
    ? 'Dados atualizados. Verifique o novo email para confirmar a alteracao, se o Supabase solicitar.'
...
const savePassword = async () => {
  ...
  const result = await authStore.updatePassword({ password: securityForm.value.password });
        ...
        <div class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div class="space-y-6">
            <section class="rounded-[28px] border border-gray-200 bg-white p-5 shadow-[0_10px_25px_rgba(15,23,42,0.04)] md:p-6">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500">Altere a palavra-passe da sua conta.</p>
                </div>
              </div>
            ...
            <section class="rounded-[28px] border border-rose-200 bg-rose-50/70 p-5 shadow-[0_10px_25px_rgba(225,29,72,0.06)] md:p-6">
              <div class="flex items-center gap-3">
                <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-rose-600 shadow-sm">
              ...
              <div class="mt-5 rounded-2xl border border-rose-200 bg-white/80 p-4">
              ...
              <button
                ...
                class="mt-5 inline-flex items-center justify-center rounded-2xl bg-rose-600 px-5 py-3 text-[14px] font-extrabold text-white shadow-[0_10px_24px_rgba(225,29,72,0.22)] transition-all hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
