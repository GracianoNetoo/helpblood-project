...
<template>
  <div class="max-w-300 mx-auto space-y-6 md:space-y-8 pb-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <!-- Stats Mini Bento -->
      <div class="lg:col-span-4 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-1 grid-rows-1 lg:grid-rows-2 gap-6 h-full">
        
        <div class="bg-white rounded-4xl p-6 border border-gray-200/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:shadow-md transition-all">
          <div class="absolute -right-6 -top-6 w-32 h-32 bg-rose-50 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>
          <div class="w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center mb-6 border border-rose-100/50">
        ...
        <div class="bg-white rounded-4xl p-6 border border-gray-200/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:shadow-md transition-all">
          <div class="absolute -right-6 -bottom-6 w-32 h-32 bg-blue-50 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>
          <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-6 border border-blue-100/50">
            <Droplet class="w-6 h-6" stroke-width="2.5" />
          </div>
          <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <!-- Digital Card Bento -->
      <div class="lg:col-span-5 bg-linear-to-br from-[#FAFAFA] to-[#F1F5F9] rounded-4xl p-8 md:p-10 border border-gray-200/60 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex flex-col justify-center items-center relative overflow-hidden z-0">
        <div class="absolute inset-0 bg-[radial-gradient(#E2E8F0_1px,transparent_1px)] bg-size-[24px_24px] opacity-60"></div>
        ...
        <!-- Sleek Card Mockup (21st.dev style) -->
        <div class="relative z-10 w-full max-w-sm aspect-[1.586/1] rounded-4xl p-6 bg-white/40 backdrop-blur-3xl border border-white shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1),0_0_0_1px_rgba(255,255,255,0.5)_inset] flex flex-col justify-between overflow-hidden group">
          <div class="absolute -top-25 -left-25 w-62.5 h-62.5 bg-white/80 rounded-full blur-[50px] pointer-events-none group-hover:scale-110 transition-transform duration-1000"></div>
          <div class="absolute -bottom-25 -right-12.5 w-50 h-50 bg-rose-400/20 rounded-full blur-2xl pointer-events-none group-hover:bg-rose-400/30 transition-all duration-1000"></div>
          
          <div class="flex justify-between items-center relative z-10">
            <div class="flex gap-2 items-center text-gray-800">
              <Droplet class="w-5 h-5 text-rose-600 fill-rose-600/20" />
              <span class="text-[13px] font-black tracking-widest uppercase">UniVida</span>
            </div>
            <div>
              <span class="text-[9px] font-extrabold text-gray-500 uppercase tracking-[0.2em] bg-white/60 px-2.5 py-1.5 rounded-full border border-white shadow-sm mix-blend-multiply">Doador Nacional</span>
            </div>
          </div>
