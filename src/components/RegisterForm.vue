    ...
    <form @submit.prevent="handleSubmit"
        ...
        <div class="pt-4">
            <button type="submit" :disabled="isFormInvalid" 
                class="w-full bg-rose-600 hover:bg-rose-700 text-white rounded-[16px] px-6 py-4 font-extrabold text-[15px] shadow-[0_8px_20px_rgba(225,29,72,0.2)] transition-all hover:-translate-y-0.5 mt-2 flex justify-center items-center gap-2 group tracking-wide disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:-translate-y-0">
