  ...
  <section id="campanhas" class="py-24 bg-[#FAFAFA] relative overflow-hidden border-t border-gray-100">
    <div class="container mx-auto px-6 max-w-7xl relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-4xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_40px_rgba(225,29,72,0.06)] hover:border-rose-100 border border-gray-100 group transition-all duration-500 flex flex-col relative z-20">
          <!-- Image Section -->
          ...
          <!-- Content Section -->
          <div class="p-8 flex flex-col flex-1 transform translate-y-0 relative z-30 bg-white group-hover:-translate-y-2 transition-transform duration-500 rounded-b-4xl border-t border-gray-50 -mt-2">
            <div class="flex items-center gap-4 text-[13px] font-semibold text-gray-400 mb-4 bg-gray-50 w-fit px-3 py-1.5 rounded-full">
              <span class="flex items-center gap-1.5 text-gray-700">
                <MapPin class="w-3.5 h-3.5 text-rose-500" stroke-width="2.5" /> Luanda
              </span>
              <span class="w-0.75 h-0.75 rounded-full bg-gray-300"></span>
              <span class="flex items-center gap-1.5">
                <CalendarDays class="w-3.5 h-3.5" stroke-width="2" /> Hoje, 10h - 15h
              </span>
            </div>
        ...
        <!-- Drive Campaign Card -->
        <div class="bg-white rounded-4xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:border-gray-200 border border-gray-100 group transition-all duration-500 flex flex-col relative z-20">
          <!-- Image Section -->
          <div class="h-55 overflow-hidden relative">
          ...
          <div class="p-8 flex flex-col flex-1 transform translate-y-0 relative z-30 bg-white group-hover:-translate-y-2 transition-transform duration-500 rounded-b-4xl border-t border-gray-50 -mt-2">
            <div class="flex items-center gap-4 text-[13px] font-semibold text-gray-400 mb-4 bg-gray-50 w-fit px-3 py-1.5 rounded-full">
              <span class="flex items-center gap-1.5 text-gray-700">
                <MapPin class="w-3.5 h-3.5 text-gray-400" stroke-width="2.5" /> Benguela
              </span>
              <span class="w-0.75 h-0.75 rounded-full bg-gray-300"></span>
              <span class="flex items-center gap-1.5">
                <CalendarDays class="w-3.5 h-3.5" stroke-width="2" /> Próx Sáb, 08h
              </span>
            </div>
            ...
            <button @click="emit('click-agendar-horario')" class="w-full py-4 text-[14px] bg-white border-2 border-gray-100 text-gray-900 font-bold rounded-2xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2">
              Agendar Horário
        ...
        <div class="bg-linear-to-br from-[#0F172A] to-[#1E293B] rounded-4xl p-8 md:p-10 flex flex-col justify-between text-white relative overflow-hidden group shadow-2xl h-full">
            ...
            <div class="relative z-10 h-full flex flex-col justify-start">
              ...
              <button @click="emit('click-solicitar-parceria')" class="w-full bg-white text-gray-900 px-6 py-4 rounded-2xl font-extrabold text-[14px] uppercase tracking-wider hover:bg-gray-100 hover:scale-[1.02] shadow-[0_4px_14px_rgba(255,255,255,0.2)] transition-all flex justify-center items-center gap-2">
                Solicitar Parceria
